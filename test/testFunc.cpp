...
void test(const unsigned char *img1, const unsigned char *img2, const uint *width1, const uint *height1, const uint *width2, const uint *height2, const uint *channels1, const uint *channels2)
{
    ...
    free(compositionSerial(img1, img2, *width1, *height1, *channels1, *width2, *height2, *channels2, UP, &outW, &outH));
    ...
    for (int i = 2; i <= 20; i++)
    {
        ...
        for (int j = 0; j < 100; j++)
        {
            ...
            free(compositionOmp(img1, img2, *width1, *height1, *channels1, *width2, *height2, *channels2, UP, &outW, &outH, i));
